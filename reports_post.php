...
<body>
	...
	<?php 
	$keyboardDesignRating = $_POST['keyboardRadioDesign'];
	$keyboardRGBRating = $_POST['keyboardRadioRGB'];
	$keyboardSwitchesRating = $_POST['keyboardRadioSwitches'];
	$keyboardResponseRating = $_POST['keyboardRadioResponseTime'];
	$keyboardFormRating = $_POST['keyboardRadioFormFactor'];
	...
	<!-- Headset Ratings:  -->
	<?php 
	$headsetDesignRating = $_POST['headsetRadioDesign'];
	$headsetQualityRating = $_POST['headsetRadioQuality'];
	$headsetVolumeRating = $_POST['headsetRadioVolume'];
	$headsetComfortRating = $_POST['headsetRadioComfort'];
	$headsetMicrophoneRating = $_POST['headsetRadioMicrophone'];
	
	echo "<h4>Gaming Headset</h4><br>";
	echo "<table>
		<tr><th>Attribute</th><th>Rating</th></tr>
	...
	<!-- Mouse Ratings:  -->
	<?php 
	$mouseDesignRating = $_POST['mouseRadioDesign'];
	$mouseRGBRating = $_POST['mouseRadioRGB'];
	$mouseButtonRating = $_POST['mouseRadioButtons'];
	$mouseConnectivityRating = $_POST['mouseRadioConnectivity'];
	$mouseResponseRating = $_POST['mouseRadioResponseTime'];
